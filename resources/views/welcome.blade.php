        ...
        <div class="content-panel">
            <div class="section">
                ...
                <div class="stack-grid">
                    ...
                    <div class="stack-item"><div class="stack-icon purple">SW</div><span>RoadRunner</span></div>
            ...
            <div class="section">
                ...
                <div class="services-list">
                    <div class="service-row">
                        ...
                        <span class="service-name">Laravel Octane · RoadRunner</span>
            ...
            <div class="section">
                <div class="section-title">Nginx + PHP-FPM vs Octane + RoadRunner</div>
                <table class="compare-table">
                    <thead>
                    <tr>
                        <th>Аспект</th>
                        <th>Nginx + PHP-FPM</th>
                        <th class="highlight">Octane + RoadRunner</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td class="highlight">1 (RoadRunner HTTP server)</td>
                    </tr>
                    <tr>
                        <td>Протокол</td>
                        <td>FastCGI</td>
...
<footer class="site-footer">
    Laravel Octane + RoadRunner · <a href="https://laravel.com/docs/13.x/octane" class="footer-link">laravel.com/docs/octane</a>
</footer>
</body>
</html>
